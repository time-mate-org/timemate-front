      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead sx={{ bgcolor: '#1a1a1a' }}>
            <TableRow>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Cliente</TableCell>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Profissional</TableCell>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Serviço</TableCell>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Data</TableCell>
