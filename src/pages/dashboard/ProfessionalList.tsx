...
const ProfessionalList = () => {
  ...
  const professionals = [
    { id: 1, name: 'Dr. Carlos', profession: 'Médico', phone: '(11) 99999-8888' },
    { id: 2, name: 'Ana Souza', profession: 'Advogada', phone: '(11) 99999-7777' }
  ];
      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead sx={{ bgcolor: '#1a1a1a' }}>
            <TableRow>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Nome</TableCell>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Profissão</TableCell>
              <TableCell sx={{ color: '#00ff9d', fontWeight: 600 }}>Telefone</TableCell>
